...
const flagshipEvidence: Record<string,EvidenceItem[]> = {
  RESIDUAL:[
    {label:'Receipt integrity / StationReceipt',state:'IMPLEMENTED',summary:'Revision 2f9dda38: typed, frozen receipts bind task, artifact hash, verifier identity/revision, verdict, parent lineage and engine identity.',href:'https://github.com/ninja-ops-guy/residual-agent-harness/blob/2f9dda3882f39c28a1c766859b1bf9579eea7911/residual/receipts.py',action:'CODE @ 2f9dda38'},
    {label:'Receipt adversarial tests',state:'TESTED',summary:'Exact-revision red-team coverage attacks receipt integrity rather than relying on happy-path construction.',href:'https://github.com/ninja-ops-guy/residual-agent-harness/blob/2f9dda3882f39c28a1c766859b1bf9579eea7911/tests/redteam/test_receipt_attacks.py',action:'TESTS @ 2f9dda38'},
    {label:'Worker contracts / M2',state:'TESTED',summary:'WorkerContract implementation explicitly distinguishes lexical policy from OS enforcement; dedicated Factory tests exercise the contract boundary.',href:'https://github.com/ninja-ops-guy/residual-agent-harness/blob/2f9dda3882f39c28a1c766859b1bf9579eea7911/tests/test_factory_worker_contract.py',action:'TESTS @ 2f9dda38'},
    {label:'Evidence bus / deterministic integrator',state:'TESTED',summary:'Dedicated M3/M4 tests cover evidence-bus and deterministic-integration behavior on the exact referenced revision.',href:'https://github.com/ninja-ops-guy/residual-agent-harness/blob/2f9dda3882f39c28a1c766859b1bf9579eea7911/tests/test_factory_m4_integrator.py',action:'M4 TESTS @ 2f9dda38'},
    {label:'Implementation traceability manifest',state:'IMPLEMENTED',summary:'Machine-readable manifest maps requirement families to code paths, tests, closure state and explicit unverified/partial states.',href:'https://github.com/ninja-ops-guy/residual-agent-harness/blob/2f9dda3882f39c28a1c766859b1bf9579eea7911/implementation-status.yaml',action:'TRACEABILITY @ 2f9dda38'},
    {label:'Clean-install qualification',state:'TESTED',summary:'Exact-main push workflow completed successfully for revision 2f9dda38.',href:'https://github.com/ninja-ops-guy/residual-agent-harness/actions/runs/35452581180',action:'CI RUN'},
    {label:'Measured-evaluation acceptance binding',state:'TESTED',summary:'Exact-main push workflow completed successfully for revision 2f9dda38.',href:'https://github.com/ninja-ops-guy/residual-agent-harness/actions/runs/35452581184',action:'CI RUN'},
    {label:'Factory ownership gate',state:'TESTED',summary:'Exact-main push workflow completed successfully after PR #338 advanced the ownership pin.',href:'https://github.com/ninja-ops-guy/residual-agent-harness/actions/runs/35452581191',action:'CI RUN'},
    {label:'RuntimeJournal admission repair',state:'OBSERVED',summary:'PR #338 is a concrete example of qualification finding an ownership/write-admission defect and landing a repair on main.',href:'https://github.com/ninja-ops-guy/residual-agent-harness/pull/338',action:'PR #338'},
    {label:'Production qualification',state:'PENDING',summary:'A successful subset of exact-main qualification does not imply universal production readiness; remaining release gates stay explicitly open.'}
  ],
  'RAC / Adversarial Clothing':[
    {label:'Negative result D2-0003',state:'OBSERVED',summary:'The exact-revision evidence record preserves the D2-0003 outcome rather than removing an unsuccessful generation.',href:'https://github.com/ninja-ops-guy/adversarial-clothing-pipeline/blob/ed106c55438389110ce33a47c17039438e6679b0/manuscript/evidence/RAC-PER-D2-0003/d2-latest-status.json',action:'EVIDENCE @ ed106c55'},
    {label:'Negative result D2-0004 closure',state:'OBSERVED',summary:'Closure documentation records D2-0004 and its evidence boundary instead of promoting it as efficacy.',href:'https://github.com/ninja-ops-guy/adversarial-clothing-pipeline/blob/ed106c55438389110ce33a47c17039438e6679b0/docs/D2-0004_CLOSURE_NOTE.md',action:'CLOSURE @ ed106c55'},
    {label:'Attested D2-0004 evidence',state:'TESTED',summary:'The manuscript evidence tree retains an attested evidence artifact for the closed generation.',href:'https://github.com/ninja-ops-guy/adversarial-clothing-pipeline/blob/ed106c55438389110ce33a47c17039438e6679b0/manuscript/evidence/RAC-PER-D2-0004/log-attested-evidence.json',action:'ARTIFACT @ ed106c55'},
    {label:'Provenance implementation',state:'IMPLEMENTED',summary:'Pattern Genome provenance is implemented as a dedicated module on the exact referenced revision.',href:'https://github.com/ninja-ops-guy/adversarial-clothing-pipeline/blob/ed106c55438389110ce33a47c17039438e6679b0/ruthless_pipeline/pattern_genome/provenance.py',action:'CODE @ ed106c55'},
    {label:'Physical P1 operator protocol',state:'PENDING',summary:'The physical program has an operator runbook, but existence of a protocol is not evidence of physical efficacy.',href:'https://github.com/ninja-ops-guy/adversarial-clothing-pipeline/blob/ed106c55438389110ce33a47c17039438e6679b0/physical/p1/P1_OPERATOR_RUNBOOK.md',action:'PROTOCOL @ ed106c55'}
  ]
};
