...
const secondary = [
  ...
  ['Vector / WirePod Embodied AI','An embodied-agent research platform built around Anki Vector, WirePod, MCP, and the Vector SDK. Typed LLM control and reusable robot skills are already working; the next stage uses RESIDUAL to turn requested behaviors into bounded, verified Python SDK code before anything is promoted to the robot. The research question is whether that loop can become a practical form of governed dynamic learning: observe → orient → propose → verify → act → measure → retain.','https://github.com/ninja-ops-guy/vector-swarm-ai','','/case-study/vector-wirepod','PRIVATE REPO · PUBLIC RELEASE PLANNED'],
  ['COMPASS','A privacy-first, compass-driven nearest-dispensary locator using foreground geolocation, device orientation, OpenStreetMap / Overpass discovery, mirror failover, caching, and an installable PWA shell.','https://github.com/ninja-ops-guy/420Flower-Locator','https://ninja-ops-guy.github.io/420Flower-Locator/','','LIVE · PUBLIC'],
  ['Second Date','A product-lifecycle tracker for the after-opening clock on food, beauty, wellness, and home products. Includes guest mode, accounts, reminders, printable labels, product analytics, and Stripe-backed Plus subscription infrastructure.','https://github.com/ninja-ops-guy/Second-Date','https://ninja-ops-guy.github.io/Second-Date/','','PUBLIC · MONETIZATION BUILD'],
  ['Standby','A marketplace prototype for transferring prepaid reservations and other time-bound bookings, with simulated escrow, settlement, platform fees, boosts, refunds, wallet balances, payouts, and concurrency-safe listing transitions.','https://github.com/ninja-ops-guy/Standby','https://ninja-ops-guy.github.io/Standby/','','PUBLIC · MARKETPLACE PROTOTYPE'],
];
