...
const experiences = [
  {
    ...
    subtitle: 'Windows Server, AD, DNS, Citrix, PXE, MDT, SNMP Automation',
    image: 'https://tjsizcvhdprxa.kimi.page/images/exp-infra.jpg',
  },
  {
    title: 'AI & ROBOTICS',
    subtitle: 'Embodied AI, multi-agent orchestration, local LLM inference, swarm networking',
    image: 'https://tjsizcvhdprxa.kimi.page/images/exp-ai.jpg',
  },
  {
    title: 'CYBERSECURITY',
    subtitle: 'Vulnerability assessment, pentesting, incident response, TryHackMe 125+ rooms',
    image: 'https://tjsizcvhdprxa.kimi.page/images/exp-sec.jpg',
  },
  {
    title: 'ENTERPRISE IT',
    subtitle: 'Hardened kiosk systems, production recovery, ticket queue management, imaging',
    image: 'https://tjsizcvhdprxa.kimi.page/images/exp-enterprise.jpg',
  },
  {
    title: 'QUANTITATIVE SYSTEMS',
    subtitle: 'Prediction market algorithms, ensemble ML, Kelly criterion risk management',
...
export default function ImmersiveExperiences() {
  ...
  useEffect(() => {
    ...
    cards.forEach((card, index) => {
      ...
      if (index !== cards.length - 1) {
        tl.fromTo(images, { scale: 2 }, { scale: 1, duration: 1 }, '<');
      }
      ...
      if (index === cards.length - 1) {
        tl.set(getImages(card), { scale: 1 }, 0);
      }
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className="relative"
      style={{ background: '#050A14', zIndex: 1 }}
    >
      {/* Section header */}
      <div className="text-center" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
        <p className="font-label" style={{ marginBottom: '24px' }}>
          TECHNICAL DOMAINS
        </p>
        <h2
          className="font-headline mx-auto px-6"
          style={{
      ...
      {/* Scroll-anchored viewport-switch sequence */}
            ...
            >
              ...
              >
                <img
                  ...
                  style={{
                    transform: index === experiences.length - 1 ? 'scale(1)' : 'scale(2)',
                  }}
                  loading="lazy"
                />
                <div
      ...
      <div className="text-center" style={{ padding: '80px 0 120px' }}>
        <p
          className="font-body"
          style={{ fontSize: '16px', color: '#8899AA' }}
        >
          Scroll to explore the full spectrum of expertise.
        </p>
      </div>
    </section>
  );
