...
const programs = [
  {
    ...
    artifacts: 'RESIDUAL / Command Station · verified cyber planning · agent orchestration',
    contribution: 'Contracts, bounded execution, evidence receipts, deterministic acceptance, planner verification, model routing, durable state, and fail-closed control surfaces.',
  },
  {
    title: 'COMPUTATIONAL COMPLEXITY & VERIFICATION',
    question: 'What structural properties explain when computation, proof, and search become tractable or difficult?',
    artifacts: 'CIC · SAT research · proof systems · formalization',
    contribution: 'Graph-structured complexity measures, solver experiments, proof-system analysis, computational verification, theorem development, and explicit separation of empirical results from open gaps.',
  },
  {
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-10">
        ...
        <div style={{ marginTop: '80px', padding: '32px', border: '1px solid #1a2540', background: '#0A1020' }}>
          ...
          <p className="font-body" style={{ color: '#B1BECC', fontSize: '15px', lineHeight: 1.75, maxWidth: '950px', margin: 0 }}>
            I separate what is proved from what is observed, benchmarked, engineered, preregistered, or still open. The purpose is not to make every result look successful; it is to make the state of the evidence legible.
          </p>
