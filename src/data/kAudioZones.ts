...
export const K_ZONE_LABELS: Record<KAudioZone, string> = {
  ...
  city: 'K//CITY',
  spring: 'SPRING // VERNAL COURT',
  summer: 'SUMMER // SOLAR CLOISTER',
  autumn: 'AUTUMN // RUST PROCESSIONAL',
  winter: 'WINTER // WHITEOUT GRID',
  light: 'LIGHT // LUMEN ARCOLOGY',
  dark: 'DARK // BLACKOUT WASTELAND',
  car: 'K//DRIVE',
  flight: 'LUMEN FLIGHT',
  ambient: 'K//AMBIENT',
};
